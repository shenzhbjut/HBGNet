...
counter=100
def plot_output(rgb_img,rgb_img_1, depth_img, grasp_q_img, grasp_angle_img, no_grasps=5, grasp_width_img=None,
    ...
    if input("input") == "1":
        ...
        #     g.plot(plot)
        plt.axis("off")
        plt.savefig('/media/a822/d5a80d83-d319-4b7b-aa03-354f28c8c2db/xxx/RGB_1_%d.pdf'%counter, bbox_inches='tight')
        plt.show()
        plt.imshow(rgb_img)
        for g in gs_2:
            g.plot(plt)
        ...
        #     g.plot(plot)
        plt.axis("off")
        plt.savefig('/media/a822/d5a80d83-d319-4b7b-aa03-354f28c8c2db/xxx/RGB_2_%d.pdf' % counter, bbox_inches='tight')
        plt.show()

        plot1 = plt.imshow(grasp_q_img, cmap="jet", vmin=0, vmax=1)
        plt.axis("off")
        plt.colorbar(plot1)
        plt.savefig('/media/a822/d5a80d83-d319-4b7b-aa03-354f28c8c2db/xxx/Q_1_%d.pdf'%counter, bbox_inches='tight')
        plt.show()
        plot1 = plt.imshow(grasp_q_img_ggcnn, cmap="jet", vmin=0, vmax=1)
        plt.axis("off")
        plt.colorbar(plot1)
        plt.savefig('/media/a822/d5a80d83-d319-4b7b-aa03-354f28c8c2db/xxx/Q_2_%d.pdf' % counter, bbox_inches='tight')
        plt.show()
        #
        counter=counter+1
    # if input("input") == "1":
